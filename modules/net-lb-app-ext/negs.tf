locals {
  neg_endpoints_global_tmp = flatten([
  ...
  neg_endpoints_zonal_tmp = flatten([
  ...
  neg_endpoints_global = {
    for v in local.neg_endpoints_global_tmp : (v.key) => v
  }
  neg_endpoints_zonal = {
    for v in local.neg_endpoints_zonal_tmp : (v.key) => v
  }
  neg_global = {
